...
if (!KODE_KLPD) {
  console.error("❌ kode_klpd wajib diisi. Contoh: node penyedia.js D145 2026 100");
  process.exit(1);
}

if (Number.isNaN(TAHUN) || TAHUN < 2000) {
  console.error("❌ tahun tidak valid. Contoh: node penyedia.js D145 2026 100");
  process.exit(1);
}
...
async function exportKeExcel() {
  ...
  console.log(
    `▶️ Mulai export: kode_klpd=${KODE_KLPD}, tahun=${TAHUN}, limit=${LIMIT}\n`
  );
